...
const solutions = [
  {
    name: "Flag Memory Game - Single Player",
    description: "flags cards memory game for one.",
    href: "/flag-memory-cards/one-player",
    icon: FlagIcon,
  },
  {
    name: "Flag Memory Game - Two Players",
    description: "Flags cards memory game for two.",
    href: "/flag-memory-cards/two-players",
    icon: FlagIcon,
  },
  {
    name: "Country Capital Memory Game",
    description: "Learn country flags and capitals with this memory game.",
    href: "/flag-capital-memory-cards/one-player",
    icon: GlobeAltIcon,
  },
  {
    name: "Coming soon",
